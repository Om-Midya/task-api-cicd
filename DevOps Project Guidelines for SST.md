...
* Identify a **real-world application** built by the learner (Any language preferred, but flexible)  
...
| Setup Runtime | Install Any language / language runtime |
...
| Secret Name | Purpose |
| ----- | ----- |
| DOCKERHUB\_USERNAME | Docker registry user |
| DOCKERHUB\_TOKEN | Secure registry access |
